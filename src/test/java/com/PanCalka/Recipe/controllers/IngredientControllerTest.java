...
public class IngredientControllerTest {
    ...
    @Test
    public void shouldListAllIngredients() throws Exception {
        //given
    ...
    @Test
    public void shouldAddNewIngredientForm() throws Exception {
        // given
    ...
    public void shouldDeleteIngredient() throws Exception {
        ...
        verify(ingredientService, times(1)).deleteRecipeById(anyLong(), anyLong());
    }
}