...
public class RecipeBootstrap {
    ...
    public RecipeBootstrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
        ...
        private List<Recipe> getRecipe() {
            ...
            Optional<UnitOfMeasure> cupsUom = unitOfMeasureRepository.findByDescription("Cups");
            ...
            random.getIngredients().add(new Ingredient("jummy recipe", new BigDecimal(2), eachUom));
            random.getIngredients().add(new Ingredient("jummy recipe1", new BigDecimal(3), pintUom));
            random.getIngredients().add(new Ingredient("jummy recipe2", new BigDecimal(4), teaspoon));
